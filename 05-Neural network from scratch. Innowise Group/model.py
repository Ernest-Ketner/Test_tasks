...
class Nesterov_SGD:
    ...
    def update_params(self, layer):
        ...
        layer.weights += self.momentum * layer.weight_momentums - self.current_learning_rate * layer.dweights
        layer.biases += self.momentum * layer.bias_momentums - self.current_learning_rate * layer.dbiases
...
class Model:
        ...
        for epoch in range(1, epochs+1):
            ...
            for step in range(train_steps):
                ...
                if not step % print_every or step == train_steps - 1:
                    ...
                    self.train_loss.append(data_loss)
    ...
    def evaluate(self, X_val, y_val, *, batch_size=None):
        ...
        self.valid_accuracy.append(validation_accuracy)
